...
export interface ISubscriptionIterator<T = any> {
    (parent: any, args: Record<string, any>, context: any, info: GraphQLResolveInfo): AsyncIterator<ISubscriptionPayload<T>> | Promise<AsyncIterator<ISubscriptionPayload<T>>>;
}
...
export interface ISubscriptionMiddleware {
     ...
     */
    beforeSubscribe?(name: string, variables: Record<string, any>, context: any): Promise<void>;
    /**
     * Execute after subscription starts
     */
    afterSubscribe?(subscriptionId: string, name: string, context: any): Promise<void>;
    /**
     * Execute before publishing
     */
    beforePublish?<T>(topic: string, payload: ISubscriptionPayload<T>): Promise<ISubscriptionPayload<T>>;
    /**
     * Execute after publishing
     */
    afterPublish?<T>(topic: string, payload: ISubscriptionPayload<T>, subscriberCount: number): Promise<void>;
    /**
     * Execute on subscription error
     */
    onError?(error: Error, subscriptionId?: string, context?: any): Promise<void>;
}
export interface ISubscriptionAuth {
    /**
     * Authenticate subscription request
     */
    authenticate(request: FastifyRequest, subscriptionName: string, variables: Record<string, any>): Promise<boolean>;
    /**
     * Authorize subscription for user
     */
    authorize(userId: string, subscriptionName: string, variables: Record<string, any>): Promise<boolean>;
    /**
     * Get user context from request
     */
    getUserContext(request: FastifyRequest): Promise<any>;
}
//# sourceMappingURL=ISubscriptionManager.d.ts.map